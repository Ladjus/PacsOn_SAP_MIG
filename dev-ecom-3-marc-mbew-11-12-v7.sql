...
v.6: Always AR.artbeskrspec from 2000 mallbolaget alias AR_2000. Other columns from operational company alias AR_OP, except tax classification.
     Add column MARC_RUN_ID.
v.7: New logic for valuation price, prio 3 & 4, columns MBEW_VERPR and MBEW_PEINH.
*/
