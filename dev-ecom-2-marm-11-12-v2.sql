...
--  XARE.AltEnhetOmrFaktor AS MARM_UMREZ,  -- Numerator for Conversion to Base Unit
  IIF(FLOOR(XARE.AltEnhetOmrFaktor) = CEILING(XARE.AltEnhetOmrFaktor), ROUND(XARE.AltEnhetOmrFaktor, 0), XARE.AltEnhetOmrFaktor) AS MARM_UMREZ,  -- Numerator for Conversion to Base Unit. Integer if possible.
